...
export default {
  ...
  effects: {
    ...
    *create({ payload },{ call,put }) {
      ...
      const result = yield call(create,`${window.MC.BASEHOST}/api/sys/oauth/login`,{...payload});
      if (result.code === 200) {
    ...
    *onRegister({ payload },{ call,put,select }) {
      ...
      const result = yield call(create,`${window.MC.BASEHOST}/api/sys/oauth/register`,data);
      if (result.code === 200) {
