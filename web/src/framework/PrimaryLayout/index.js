            ...
            <Header className="header" style={{ height:'64px',padding:0,backgroundColor:'#fff'}}>
              {/*<div className="logo" />*/}
                ...
                {/*<Menu
                  ...
                  style={{ lineHeight: '64px',position:'fixed',top:0,left:0,right:0,zIndex:999}}
                >
                  <Menu.Item key="1">CR系统</Menu.Item>
                </Menu>*/}
              <div style={{ display: 'flex',justifyContent:'space-between'}}>
                <div style={{ display:'flex',marginLeft: '2em',alignItems:'center'}}>
                  <img style={{width:'40px',height:'40px'}} src={require('../../assets/logo.png')}/>
                  <div style={{ marginLeft:"1em"}}>CR Management</div>
                </div>
